...
def train_and_evaluate(
    ...
    for batch_idx, (
        ...
        bert, bert_lengths = bert.cuda(rank, non_blocking=True), bert_lengths.cuda(
            rank, non_blocking=True
        )
        ...
        with autocast(enabled=hps.train.fp16_run):
            (
                ...
                (hidden_x, logw, logw_),
            ) = net_g(x, x_lengths, spec, spec_lengths, bert, bert_lengths, speakers)
...
def evaluate(hps, generator, eval_loader, writer_eval):
    ...
    with torch.no_grad():
        for batch_idx, (
            ...
            bert, bert_lengths = bert.cuda(0), bert_lengths.cuda(0)
            ...
            bert = bert[:1]
            bert_lengths = bert_lengths[:1]
            speakers = speakers[:1]
            break
        y_hat, attn, mask, *_ = generator.module.infer(
            x, x_lengths, bert, bert_lengths, speakers, max_len=1000
        )
